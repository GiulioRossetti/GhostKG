...
class FSRSConfig:
    ...
    """
    parameters: List[float] = field(default_factory=lambda: [
...
class FastModeConfig:
    ...
    sentiment_thresholds: Dict[str, float] = field(default_factory=lambda: {
        "support": 0.3,
        "oppose": -0.3,
        "like": 0.1,
        "dislike": -0.1,
...
class GhostKGConfig:
    ...
    def from_env(cls, prefix: str = "GHOSTKG") -> 'GhostKGConfig':
        ...
        database = DatabaseConfig(
            ...
            check_same_thread=get_env("DATABASE", "CHECK_SAME_THREAD", DatabaseConfig.check_same_thread, bool),
