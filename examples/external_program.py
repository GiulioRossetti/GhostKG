...
def run_external_program_example():
    ...
    for i in range(num_rounds):
        ...
        manager.absorb_content("Bob", last_content, author=last_author, triplets=triplets)
        ...
        manager.absorb_content("Alice", last_content, author=last_author, triplets=triplets)
    ...
    for agent_name in ["Alice", "Bob"]:
        ...
        for belief in knowledge['agent_beliefs'][:3]:
            print(f"      - I {belief['relation']} {belief['target']} (sentiment: {belief.get('sentiment', 0):.2f})")
